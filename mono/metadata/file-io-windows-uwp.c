...
gboolean
mono_file_io_replace_file (gunichar2 *destinationFileName, gunichar2 *sourceFileName, gunichar2 *destinationBackupFileName, guint32 flags, gint32 *error)
{
	gboolean result = FALSE;
	MONO_ENTER_GC_SAFE;
...
void __mono_win32_fileio_windows_uwp_quiet_lnk4221(void) {}
#endif
